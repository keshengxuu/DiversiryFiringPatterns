...
for val in Vals:
    if isim%threads==rank:
        ...
        net = Networkmodel(Ne1 =Ne,   # The numbers of excitatroy ensemble
              ...
              W_gap =0.1, # the weight of gap junction for excitatoty population.
        ...
        plt.savefig("Gap01EISW_JeeVsJei_PSW001_plots/Jee_%02d_Jei_%02d.png"%(jee*100,jei*1000),dpi=300)
        print("ready sim %g rank%g (%g,%g)"%(isim,rank,jee,jei))        

        with open("Gap01EISW_JeeVsJei_PSW001_data/results.txt_%04d"%isim,'a') as outfile:
